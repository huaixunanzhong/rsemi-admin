...
import { Avatar, Tag, Typography } from "@douyinfe/semi-ui-19";

import type { DataCardProps } from "@/components/DataCard.tsx";

const { Title } = Typography;

export const data1List: DataCardProps["data"][] = [
  {
